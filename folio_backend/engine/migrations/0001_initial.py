# Generated by Django 4.0.3 on 2022-05-14 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField()),
                ('price', models.FloatField()),
                ('stock', models.ForeignKey(db_column='stock', on_delete=django.db.models.deletion.CASCADE, related_name='price', to='engine.stock')),
            ],
            options={
                'db_table': 'stockprice',
                'managed': True,
